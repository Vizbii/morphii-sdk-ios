...
```
pod 'MorphiiSDK', :git => 'https://github.com/Vizbii/morphii-sdk-ios.git', :tag => '0.0.34' 
```
6. Run pod install
7. Inside of your project, go to build settings, then build options, and switch Enable Bitcode from Yes to No
8. Add import MorphiiSDK wherever you would like to utilize the SDK
