...
extension SelectedMorphiiViewController:MorphiiServiceDelegate {
    ...
    func MorphiiConfigurationDidFinish(morphiis:NSObject) {
        print(morphiis as! [Morphii])
    }
}

extension SelectedMorphiiViewController:MorphiiSelectionViewDelegate {
    func selectedMorphii(_ morphiiConfiguration: MorphiiConfiguration) {
        self.addBasicView(containerView: containerView, morphiiConfiguration: morphiiConfiguration)
    }
}
